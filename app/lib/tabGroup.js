...
exports.createTabGroup = function(args) {
    ...
    tabGroup.setActiveTab = function(index) {
        ...
        if (win.navBar) win.navBar.winTitle.text = tabToSetActive.window.title;
        if (win.navBar) win.navBar.backgroundColor = tabToSetActive.window.barColor || "#ccc";
        if (win.navBar) win.navBar.winTitle.color = tabToSetActive.window.navTextColor;
